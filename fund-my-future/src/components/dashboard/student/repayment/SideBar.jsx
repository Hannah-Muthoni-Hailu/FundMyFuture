    ...
    return (
        <div className="relative w-64 h-screen">
            ...
            <nav className="mt-6 fixed w-64 top-16">
                ...
                <Link to="/student/repayment" className="flex items-center py-2 px-4 text-indigo-700 bg-indigo-200 hover:bg-indigo-100 ">
                ...
                <Link to="/student/profile" className="flex items-center py-2 px-4 text-white hover:bg-indigo-100 hover:text-indigo-500 ">
